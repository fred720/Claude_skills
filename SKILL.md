...
ENABLE_OLLAMA_CLI: true
ENABLE_CLAUDE_CODE: true
AGENTIC_CODING_TOOLS: claude-code, ollama-cli, gemini-cli
...
- IF: The user requests a ollama CLI agent to execute the command AND `ENABLE_OLLAMA_CLI` is true.
- THEN: Read and execute: `.claude/skills/fork-terminal/cookbook/ollama-cli.md`
- EXAMPLES:
  - "fork terminal use ollama to <xyz>"
  - "spin up a new terminal request <xyz> using ollama"
  - "create a new terminal to <xyz> with ollama"
